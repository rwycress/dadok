...
class Reserve extends Component {
  ...
  render() {
    if (window.sessionStorage.getItem("seatNo"))
      return (
        <>
          <div id="bg">
            <img src={backimg} alt="" />
              ...
              <Row>
                ...
                >
                  <div style={{ height: "70vh" }}>
                    ...
                    >
                      좌석 번호 : {window.sessionStorage.getItem("seatNo")}
                    </div>
                    <div className="room-back m-auto">
                      <div className="room-container ">
                        ...
                        <div style={{ display: "table-row" }}>
                          ...
                          <div className="room-cell-bottom">
                            {window.sessionStorage.getItem("seatNo") ===
                            "10" ? (
                              <div
                                className="seat-search"
                                onClick={() => {
      ...
      return (
        <>
          ...
          <div className="content-center-unclick">
            <Container>
              <Row>
                <Col sm="12">
                  <div className="room-back m-auto">
